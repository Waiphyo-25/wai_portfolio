const Project = () => {
  const quotes = [
    ...
    },
    {
      ...
      name: "Door Dash",
      imageSrc:
        "https://doordash.nulfinancialempowerment.org/sites/default/files/GoalUp-onwhite.png",
      imageAlt: "Door Dash",
    ...
    },
    {
      id: 3,
      name: "Mega Power",
      imageSrc: "https://www.megaplanetmm.com/img/logo.png",
      imageAlt: "Megapower",
      blockquote:
        "Building ecommerce web page for helping me choose where to travel, buit with Next.js,Commerce.js, and Tailwind CSS",
      title: "Next.js Commerce.js TailwindCSS",
    },
  ];
  return (
    <div className="w-full items-center">
      <div className="mx-auto max-w-2xl items-center py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <div className="mt-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-1 lg:grid-cols-3 xl:gap-x-8">
          {quotes.map((quote) => (
            <figure
              className="h-auto w-80 rounded-xl bg-slate-800 p-4 pr-6  dark:bg-slate-900"
              key={quote.id}
            >
              <img
                className="mx-auto h-20 w-20 p-6 md:h-auto md:w-48 md:rounded-lg"
                src={quote.imageSrc}
                alt={quote.imageAlt}
                width="384"
                height="512"
